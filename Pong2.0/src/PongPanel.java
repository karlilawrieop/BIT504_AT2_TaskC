 ...
 import java.awt.Font;
  ...
  public class PongPanel extends JPanel implements ActionListener, KeyListener {
       ...
       public void keyPressed(KeyEvent event) {
    	   if(event.getKeyCode() == KeyEvent.VK_W) { // move paddle1 up using w key
               paddle1.setyVelocity(-1); // move paddle 1 up
          } else if(event.getKeyCode() == KeyEvent.VK_S) { // move paddle 1 down using s key
               paddle1.setyVelocity(1); // move paddle 1 down
           }
           if(event.getKeyCode() == KeyEvent.VK_UP) { // move paddle2 up using up key
               paddle2.setyVelocity(-1); // move paddle 2 up
          } else if(event.getKeyCode() == KeyEvent.VK_DOWN) { // move paddle 2 down using down key
               paddle2.setyVelocity(1); // move paddle 2 down
           }
       }
      ...
      public void keyReleased(KeyEvent event) {
    	  if(event.getKeyCode() == KeyEvent.VK_W || event.getKeyCode() == KeyEvent.VK_S) {
              paddle1.setyVelocity(0); // release for paddle 1
          }
    	  if(event.getKeyCode() == KeyEvent.VK_UP || event.getKeyCode() == KeyEvent.VK_DOWN) {
              paddle2.setyVelocity(0); // release for paddle 2
          }
      }
